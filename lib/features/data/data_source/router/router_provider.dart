...
import 'package:jv_services/features/presentation/register/otp_route/register_otp_screen.dart';
...
class GoRouterProvider {
  ...
  late final GoRouter _router = GoRouter(
        ...
        GoRoute(
            ...
            routes: [
              ...
              GoRoute(
                  ...
                  routes: [
                    GoRoute(
                        path: AppRouteConstants.registerOTPRouteInfo.path,
                        name: AppRouteConstants.registerOTPRouteInfo.name,
                        pageBuilder: (context, state) {
      ...
      redirect: (context, GoRouterState state) {
        ...
        final isLoginOtpPath =
            state.location == AppRouteConstants.loginOTPRouteInfo.fullPath;
        final isRegisterOtpPath =
            state.location == AppRouteConstants.registerOTPRouteInfo.fullPath;
